...
class FileLoader
{
  ...
  static void Main(string[] args)
  {
    ...
    if (args.Length != 4)
    {
      Console.WriteLine("\nUsage: Gen_SSIS_Pkg_File2Table flatFile delimiter server database");
      Console.WriteLine();
      ...
      Console.WriteLine();
      Console.WriteLine("Example> Gen_SSIS_Pkg_File2Table c:\\mydir\\myfile.dat , TheServer TheDatabase");
      Console.WriteLine();
      ...
      Console.WriteLine();
      Console.WriteLine("The generated package can also be used to load the file (it appends to the created table).");
