...
class LoadData
{
  ...
  public static DbReturnStatus BulkCopyTable(String srcConnStr, String srcQuery, String dstConnStr, String dstSchema, String dstTable, int batchSize, String loadType)
  {
   ...
   public static void GenSchemaINI(String fullPathSchemaINI, String filename, String delim, String colNameHeader)
   {
    ...
    public static DbReturnStatus FilesInDir2Table(String dir, String filePattern, String hdr, String schema, String tableName, String sqlConnStr, String loadType, String delimiter, String connType,
      String logDbConnStr, String programName, String loadDataName, String sqlStatement, String destDbName, int batchSize, String worksheet, long loadDataDefKey)
    {
      ...
      foreach(String file in fileList)
      {
        ...
        loadDataOutKey = LogBeg(logDbConnStr, programName, loadDataName, sqlStatement, DateTime.Now, sqlConnStr, destDbName, schema, tableName, loadType, batchSize, dir, filePattern, worksheet, hdr, delimiter, Path.GetFileName(file), loadDataDefKey);
  ...
  public void RunLoadDefs()
  {
    ...
    while (reader.Read())
    {
      ...
      try
      {
         ...
         {
           loadDataOutKey = LogBeg(logDbConnStr, PROGRAM_NAME, loadDataName, sourceDbQuery, DateTime.Now, destConnStr, destDbName, destSchemaName, destTableName, loadType, batchSize, directory, filePattern, worksheet, header, delimiter, "", loadDataDefKey);
         ...
         else if (sourceConnType.ToUpper().Equals("CSV"))
         {
           ...
           ret = FilesInDir2Table(directory, filePattern, header, destSchemaName, destTableName, destConnStr, loadType, ",", sourceConnType,
             logDbConnStr, PROGRAM_NAME, loadDataName, sourceDbQuery, destDbName, batchSize, worksheet, loadDataDefKey);
         }
  ...
  public static long LogBeg(String connStr, String programName, String loadDataName, String sqlStatement, DateTime begDateTime, String destConnStr, String destDbName, String destSchemaName, String destTableName, String loadType, int batchSize, String directory, String filePattern, String worksheet, String header, String delimiter, String filename, long loadDataDefKey)
  {
