 ...
 * GetEpicData.cs
 *
 * Program that writes out the result set of a KB SQL query
...
namespace GetEpicData
{
    ...
    private KBSDbConnection con;
      ...
      // hostLabel
      //
      this.hostLabel.Location = new System.Drawing.Point(16, 40);
      this.hostLabel.Name = "hostLabel";
      this.hostLabel.Size = new System.Drawing.Size(112, 23);
      ...
      // hostTextBox
      //
      this.hostTextBox.Location = new System.Drawing.Point(120, 40);
    ...
    {
      string connStr = "host=" + hostDsn + ";port=6006;applicationname=TestApp;userid=" + userid + ";password=" + passwd + ";";

      // Connect to database
      con = new KBSDbConnection(connStr);
      try
      {
        con.Open();
      }
    ...
    private void dumpData()
    {
      ...
      KBSDbCommand cmdSQL = new KBSDbCommand(sqlStatement, con);
